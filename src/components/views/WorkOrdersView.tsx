              ...
              >
                ...
                <div className="flex items-center gap-3">
                  ...
                  {order.status === 'urgent' && (
                    <button
                      onClick={() => onCompleteOrder(order.id)}
                      className="bg-[#e74c3c]/20 hover:bg-[#e74c3c] text-[#e74c3c] hover:text-white px-3.5 py-1.5 rounded-full text-xs font-bold transition-all flex items-center gap-1.5 border border-[#e74c3c]/30 cursor-pointer"
                    >
